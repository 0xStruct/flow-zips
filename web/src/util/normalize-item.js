...
export function normalizeItem(accountItem, apiListing) {
  return {
    ...
    zipStatus: accountItem.zipStatus,
    zipData: accountItem.zipData,
    zipValue: accountItem.zipValue,
    zipName: accountItem.zipName,
    zipLastUnzipTime: accountItem.zipLastUnzipTime,
  }
}
